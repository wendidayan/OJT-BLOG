...
import { isAdminUnlocked } from "../utils/admin";
    ...
    <>
      <div className="max-w-5xl mx-auto px-4 py-10">
        <Reveal>
          ...
          <p className="text-stone-400 text-sm mb-8">Weekly reflections on system development, debugging, and real-world RDMS work.</p>
        </Reveal>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-stone-400">{post.read_time}</span>
                    <button
